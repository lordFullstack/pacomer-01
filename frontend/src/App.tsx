 ...
 * FAST TRACK — Connected App
 *
 * Talks to the REAL backend (Render) and REAL Supabase Auth — no mocks.
 ...
 * without a .env file, but production deploys should set real env vars
 * instead of relying on these fallbacks staying accurate.
 */
const API_BASE = import.meta.env.VITE_API_BASE || "https://pa-comer-3-0.onrender.com";
const SUPABASE_URL = import.meta.env.VITE_SUPABASE_URL || "https://lfxflopwcxrgnsagqejj.supabase.co";
